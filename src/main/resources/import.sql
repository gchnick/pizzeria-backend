...
INSERT INTO Users (full_name, email, password, role) VALUES ('John Lee', 'lee@mail.com', '$2a$10$7TB3GlYYojP3qBKEPoU2Ou1hLsX6/V5iO.V3xMLJCX0rCC0UbrPZm', 'ROLE_ADMIN');
...
INSERT INTO Products (id, name, description, price, category_id) VALUES (2, 'Pizza de pollo', 'No apta para vegetarianos pero deliciosa. La salsa barbacoa acompaña exquisitamente al pollo', 17.23, 1);
INSERT INTO Products (id, name, description, price, category_id) VALUES (3, 'Pizza 4 quesos', 'Si eres amante del queso no podrás resistirte a una combinación equilibrada de cuatro de sus variedades: mozzarella, queso azul, parmesano, provolone', 18.0, 1);
